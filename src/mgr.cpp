...
namespace madrona_gpudrive
{
    ...
    static void loadRenderObjects(render::RenderManager &render_mgr)
    {
        ...
        auto materials = std::to_array<imp::SourceMaterial>({{render::rgb8ToFloat(191, 108, 10), -1, 0.8f, 1.0f},
                                                             {
    ...
    static void loadPhysicsObjects(PhysicsLoader &loader)
    {
        ...
        imp::AssetImporter collision_asset_importer;
        auto imported_src_hulls = collision_asset_importer.importFromDisk(
